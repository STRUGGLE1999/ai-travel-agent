...
7. 打开「清单」页展示票种、日期、来源和核验标识；
8. 打开「手账」页展示实体折页式交付物，体验原生 A4 矢量打印或一键导出预光栅化无损长图；
9. 点击顶部「🛡️ 可信规划规范」，展开四大可信底线白皮书；
10. 返回首页切换北京场景：底线页展示被忽略的注入指令；生成计划后输入「返程航班改成16:15」，确认后仅第五天时间线（恭王府、取行李、去机场）被重算，其余日期不变。
